...
function CreateUnitsForPlayer12 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'hfoo', -13411.0, -14867.8, 274.502 )
    set u = CreateUnit( p, 'hfoo', -13464.1, -15049.7, 2.725 )
    set u = CreateUnit( p, 'hfoo', -13542.4, -14898.9, 121.864 )
    set u = CreateUnit( p, 'hfoo', -13372.4, -14950.1, 224.567 )
    set u = CreateUnit( p, 'hfoo', -13242.7, -14904.2, 186.136 )
endfunction
